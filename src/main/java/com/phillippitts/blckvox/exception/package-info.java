 ...
 * <ul>
 *   <li>{@link com.phillippitts.blckvox.exception.BlckvoxException} - Base exception
 *       for all application-specific errors</li>
 *   <li>{@link com.phillippitts.blckvox.exception.InvalidAudioException} - Thrown when
 *       audio data fails validation (wrong format, duration, or size)</li>
 *   <li>{@link com.phillippitts.blckvox.exception.ModelNotFoundException} - Thrown when
 *       required STT model files are missing at startup</li>
 *   <li>{@link com.phillippitts.blckvox.exception.TranscriptionException} - Thrown when
