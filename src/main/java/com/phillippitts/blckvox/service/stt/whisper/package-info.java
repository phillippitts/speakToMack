 ...
 * <p>Key Components:
 * <ul>
 *   <li>{@link com.phillippitts.blckvox.service.stt.whisper.WhisperSttEngine} - Spring
 *       component implementing {@link com.phillippitts.blckvox.service.stt.SttEngine}
 *       for Whisper integration</li>
 *   <li>{@link com.phillippitts.blckvox.service.stt.whisper.WhisperProcessManager} -
 *       Process lifecycle management (spawn, execute, timeout, cleanup)</li>
 *   <li>{@link com.phillippitts.blckvox.service.stt.whisper.ProcessFactory} - Abstraction
 *       for creating OS processes (enables hermetic testing)</li>
 *   <li>{@link com.phillippitts.blckvox.service.stt.whisper.DefaultProcessFactory} -
 ...
 * </ol>
 *
 * @see com.phillippitts.blckvox.service.stt.SttEngine
 * @see com.phillippitts.blckvox.config.stt.WhisperConfig
 * @see com.phillippitts.blckvox.service.audio.WavWriter
 * @since 1.0
 */
