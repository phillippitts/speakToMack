 ...
 * <h2>Components</h2>
 * <ul>
 *   <li>{@link com.phillippitts.blckvox.service.stt.watchdog.SttEngineWatchdog SttEngineWatchdog} -
 *       Main watchdog component that tracks engine health and performs auto-restart with
 *       sliding window budget tracking</li>
 *   <li>{@link com.phillippitts.blckvox.service.stt.watchdog.EngineFailureEvent EngineFailureEvent} -
 *       Event published when an STT engine fails during initialization or transcription</li>
 *   <li>{@link com.phillippitts.blckvox.service.stt.watchdog.EngineRecoveredEvent EngineRecoveredEvent} -
 ...
 * {@link com.phillippitts.blckvox.service.stt.watchdog.EngineFailureEvent EngineFailureEvent}
 ...
 * {@link com.phillippitts.blckvox.config.properties.SttWatchdogProperties SttWatchdogProperties}
 ...
 *
 * @since 1.0
 * @see com.phillippitts.blckvox.service.stt.watchdog.SttEngineWatchdog
 * @see com.phillippitts.blckvox.service.stt.watchdog.EngineFailureEvent
 * @see com.phillippitts.blckvox.service.stt.watchdog.EngineRecoveredEvent
 * @see com.phillippitts.blckvox.config.properties.SttWatchdogProperties
 */
package com.phillippitts.blckvox.service.stt.watchdog;
