 ...
 * @see com.phillippitts.blckvox.config.properties.ReconciliationProperties
 * @since 1.1
 */
public interface ReconciliationService {
     ...
     * @throws com.phillippitts.blckvox.exception.TranscriptionException if reconciliation fails
