 ...
 * <ul>
 *   <li>{@link com.phillippitts.blckvox.config.stt.VoskConfig} - Binds to {@code stt.vosk.*}
 *       properties (model path, sample rate, max alternatives)</li>
 *   <li>{@link com.phillippitts.blckvox.config.stt.WhisperConfig} - Binds to {@code stt.whisper.*}
 ...
 * </pre>
 *
 * @see com.phillippitts.blckvox.config.stt.VoskConfig
 * @see com.phillippitts.blckvox.config.stt.WhisperConfig
 * @see org.springframework.boot.context.properties.ConfigurationProperties
 * @since 1.0
 */
package com.phillippitts.blckvox.config.stt;
