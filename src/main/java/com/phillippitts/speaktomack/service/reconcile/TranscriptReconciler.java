 ...
 * <ul>
 *   <li>{@link impl.SimplePreferenceReconciler} - Always prefers primary engine unless empty</li>
 *   <li>{@link impl.ConfidenceReconciler} - Selects result with higher confidence score</li>
 *   <li>{@link impl.WordOverlapReconciler} - Uses Jaccard similarity to pick best coverage</li>
 * </ul>
 *
