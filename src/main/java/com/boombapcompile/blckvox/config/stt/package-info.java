 ...
 * <ul>
 *   <li>{@link com.boombapcompile.blckvox.config.stt.VoskConfig} - Binds to {@code stt.vosk.*}
 *       properties (model path, sample rate, max alternatives)</li>
 *   <li>{@link com.boombapcompile.blckvox.config.stt.WhisperConfig} - Binds to {@code stt.whisper.*}
 ...
 * </pre>
 *
 * @see com.boombapcompile.blckvox.config.stt.VoskConfig
