 ...
 * <h2>Components</h2>
 * <ul>
 *   <li>{@link com.boombapcompile.blckvox.service.stt.watchdog.SttEngineWatchdog SttEngineWatchdog} -
 *       Main watchdog component that tracks engine health and performs auto-restart with
 *       sliding window budget tracking</li>
 *   <li>{@link com.boombapcompile.blckvox.service.stt.watchdog.EngineFailureEvent EngineFailureEvent} -
 *       Event published when an STT engine fails during initialization or transcription</li>
 *   <li>{@link com.boombapcompile.blckvox.service.stt.watchdog.EngineRecoveredEvent EngineRecoveredEvent} -
 ...
 * {@link com.boombapcompile.blckvox.service.stt.watchdog.EngineFailureEvent EngineFailureEvent}
 ...
 * {@link com.boombapcompile.blckvox.config.properties.SttWatchdogProperties SttWatchdogProperties}
 ...
 *
 * @since 1.0
 * @see com.boombapcompile.blckvox.service.stt.watchdog.SttEngineWatchdog
 * @see com.boombapcompile.blckvox.service.stt.watchdog.EngineFailureEvent
 * @see com.boombapcompile.blckvox.service.stt.watchdog.EngineRecoveredEvent
 * @see com.boombapcompile.blckvox.config.properties.SttWatchdogProperties
 */
