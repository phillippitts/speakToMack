 ...
 * <p>Key Components:
 * <ul>
 *   <li>{@link com.boombapcompile.blckvox.service.stt.whisper.WhisperSttEngine} - Spring
 *       component implementing {@link com.boombapcompile.blckvox.service.stt.SttEngine}
 *       for Whisper integration</li>
 *   <li>{@link com.boombapcompile.blckvox.service.stt.whisper.WhisperProcessManager} -
 *       Process lifecycle management (spawn, execute, timeout, cleanup)</li>
 *   <li>{@link com.boombapcompile.blckvox.service.stt.whisper.ProcessFactory} - Abstraction
 *       for creating OS processes (enables hermetic testing)</li>
 *   <li>{@link com.boombapcompile.blckvox.service.stt.whisper.DefaultProcessFactory} -
 ...
 * </ol>
 *
 * @see com.boombapcompile.blckvox.service.stt.SttEngine
 * @see com.boombapcompile.blckvox.config.stt.WhisperConfig
 * @see com.boombapcompile.blckvox.service.audio.WavWriter
 * @since 1.0
 */
