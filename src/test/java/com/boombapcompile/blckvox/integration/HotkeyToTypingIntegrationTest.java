...
import com.boombapcompile.blckvox.service.fallback.FallbackManager;
...
import com.boombapcompile.blckvox.testutil.FakeTypingService;
 ...
 *
 * <p>Uses test doubles from {@link com.boombapcompile.blckvox.testutil} to avoid
 * dependencies on real hardware/binaries.
 *
 * <p><b>Architecture Note:</b> This test uses a simplified {@link TestableOrchestrator}
 * instead of the real {@link HotkeyRecordingAdapter}
...
class HotkeyToTypingIntegrationTest {
     ...
     * {@link HotkeyRecordingAdapter}
     * requires a fully configured
     * {@link SttEngineWatchdog},
