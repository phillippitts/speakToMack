...
import com.phillippitts.blckvox.service.fallback.FallbackManager;
...
import com.phillippitts.blckvox.testutil.FakeTypingService;
 ...
 *
 * <p>Uses test doubles from {@link com.phillippitts.blckvox.testutil} to avoid
 * dependencies on real hardware/binaries.
 *
 * <p><b>Architecture Note:</b> This test uses a simplified {@link TestableOrchestrator}
 * instead of the real {@link com.phillippitts.blckvox.service.orchestration.HotkeyRecordingAdapter}
...
class HotkeyToTypingIntegrationTest {
     ...
     * {@link com.phillippitts.blckvox.service.orchestration.HotkeyRecordingAdapter}
     * requires a fully configured
     * {@link com.phillippitts.blckvox.service.stt.watchdog.SttEngineWatchdog},
