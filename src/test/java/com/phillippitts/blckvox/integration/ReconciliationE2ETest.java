package com.phillippitts.blckvox.integration;
...
import com.phillippitts.blckvox.config.hotkey.TriggerType;
import com.phillippitts.blckvox.config.properties.ReconciliationProperties;
import com.phillippitts.blckvox.config.properties.SttWatchdogProperties;
...
import com.phillippitts.blckvox.service.orchestration.HotkeyRecordingAdapterBuilder;
...
import com.phillippitts.blckvox.service.reconcile.TranscriptReconciler;
import com.phillippitts.blckvox.service.reconcile.impl.ConfidenceReconciler;
import com.phillippitts.blckvox.service.reconcile.impl.SimplePreferenceReconciler;
import com.phillippitts.blckvox.service.reconcile.impl.WordOverlapReconciler;
import com.phillippitts.blckvox.service.stt.SttEngine;
import com.phillippitts.blckvox.service.stt.parallel.DefaultParallelSttService;
import com.phillippitts.blckvox.service.stt.parallel.ParallelSttService;
import com.phillippitts.blckvox.service.stt.watchdog.SttEngineWatchdog;
import com.phillippitts.blckvox.testutil.EventCapturingPublisher;
import com.phillippitts.blckvox.testutil.FakeAudioCaptureService;
import com.phillippitts.blckvox.testutil.FakeSttEngine;
import com.phillippitts.blckvox.testutil.SyncExecutor;
 ...
 *
 * <p>Uses test doubles from {@link com.phillippitts.blckvox.testutil} package.
 */
class ReconciliationE2ETest {
    ...
    void wordOverlapStrategySelectsHigherOverlap() {
        ...
        HotkeyRecordingAdapter orchestrator = HotkeyRecordingAdapterBuilder.builder()
                ...
                .metricsPublisher(
                        com.phillippitts.blckvox.service.orchestration.TranscriptionMetricsPublisher.NOOP)
