...
class ExceptionHierarchyTest {
    ...
    @Test
    void blckvoxExceptionShouldIncludeMessage() {
        BlckvoxException ex = new BlckvoxException("test error");
        assertThat(ex.getMessage()).isEqualTo("test error");
    }

    @Test
    void blckvoxExceptionShouldIncludeCause() {
        IOException cause = new IOException("IO failure");
        BlckvoxException ex = new BlckvoxException("wrapper error", cause);
    ...
    void invalidAudioExceptionShouldExtendBase() {
        ...
        assertThat(ex).isInstanceOf(BlckvoxException.class);
    }

    @Test
    void allExceptionsShouldBeRuntimeExceptions() {
        assertThat(new BlckvoxException("test")).isInstanceOf(RuntimeException.class);
